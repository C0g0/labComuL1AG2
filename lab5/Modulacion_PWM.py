...
class Modulacion_PWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Amplitud_Saw_tooth2 = Amplitud_Saw_tooth2 = 1
        ...
        self._offset2_range = Range(-5, 5, 0.01, 0, 200)
        self._offset2_win = RangeWidget(self._offset2_range, self.set_offset2, "nivel offset diente de sierra2", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._offset2_win)
        ...
        self._Amplitud_Saw_tooth2_range = Range(0, 10, 0.01, 1, 200)
        self._Amplitud_Saw_tooth2_win = RangeWidget(self._Amplitud_Saw_tooth2_range, self.set_Amplitud_Saw_tooth2, "Amplitud_Saw_tooth2", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Amplitud_Saw_tooth2_win)
    ...
    def get_Amplitud_Saw_tooth2(self):
        return self.Amplitud_Saw_tooth2

    def set_Amplitud_Saw_tooth2(self, Amplitud_Saw_tooth2):
        self.Amplitud_Saw_tooth2 = Amplitud_Saw_tooth2
