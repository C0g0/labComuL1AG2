...
# Title: Modulacion PM
# Author: LInda Barrios - Luis Cogollo
# Copyright: UIS
...
from EnvolventejComplejaPM import EnvolventejComplejaPM  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Kp_range = Range(0, 100, 0.01, 1, 200)
        ...
        self._Am_range = Range(0, 10, 0.01, 1, 200)
        ...
        self._Ac_range = Range(0, 10, 0.01, 1, 200)
        ...
        self.EnvolventejComplejaPM_0 = EnvolventejComplejaPM(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventejComplejaPM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventejComplejaPM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventejComplejaPM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventejComplejaPM_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventejComplejaPM_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventejComplejaPM_0.set_Ac(self.Ac)
