...
# Title: Diezamr_e_Polarizar
# Author: Barrios_Cogollo
# Copyright: Uis
# Description: Diezmar y Polarizar
...
class Practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Diezamr_e_Polarizar ")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Diezamr_e_Polarizar ")
        ...
        labels = ['original', 'interpolation', 'decimation', 'Signal 4', 'Signal 5',
