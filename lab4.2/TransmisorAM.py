...
from ModulacionAM import ModulacionAM  # grc-generated hier_block
...
class TransmisorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmisor AM L1A SG2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor AM L1A SG2")
        ...
        # Blocks
        ##################################################
        self._fm_range = Range(0, 20000, 100, 500, 200)
        ...
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, "Coeficiente de sensibilidad de amplitud", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.ModulacionAM_0 = ModulacionAM(
            Ac=Ac,
            Ka=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionAM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotencia_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionAM_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.ModulacionAM_0.set_Ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModulacionAM_0.set_Ac(self.Ac)
